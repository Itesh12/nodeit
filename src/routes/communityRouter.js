...
router
  ...
  .put(protect, communityController.updateCommunity)
...
router.route('/:id/ban').put(protect, communityController.ban);
...
router.route('/:id/unban').put(protect, communityController.unban);
...
router.route('/:id/subscribe').put(protect, communityController.subscribe);
...
router.route('/:id/unsubscribe').put(protect, communityController.unsubscribe);
